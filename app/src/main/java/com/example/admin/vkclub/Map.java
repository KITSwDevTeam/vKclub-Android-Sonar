...
import static com.example.admin.vkclub.R.id.map;
...
//        groundOverlayOptions.image(bitmapDescriptor);
        ...
        GroundOverlayOptions groundOverlayOptions  = new GroundOverlayOptions()
                .image(BitmapDescriptorFactory.fromResource(R.drawable.map_s))
//                .anchor(0, 1)
//                .position(KIRIROM, 8600f, 6500f)
